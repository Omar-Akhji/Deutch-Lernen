...
const hoeren1Teil1: Question[] = [
  {
    ...
    question: "Die Sprecherin schlägt vor, früher loszufahren.",
    context:
      "Text 1: Es soll erst abends regnen. Wir könnten ja schon früher los und eine kleine Tour machen... Treffen wir uns am Sportplatz?",
  ...
  },
  {
    id: 2,
    type: "multiple-choice",
    question: "Was soll der Hörer mitbringen?",
    options: ["Essen", "Getränke", "Eine Karte"],
    correctAnswer: "Getränke",
  },
  {
    id: 3,
    type: "multiple-choice",
    question: "Manuela möchte einen Schokoladenkuchen backen.",
    context:
      "Text 2: Hallo Annette... Ich brauche deine Hilfe... Du hast doch so ein tolles Rezept für einen Zitronenkuchen.",
    options: ["Richtig", "Falsch"],
  ...
  },
  {
    id: 4,
    type: "multiple-choice",
    question: "Was möchte Manuela von Annette wissen?",
    options: [
      "Wie lange der Kuchen backen muss",
      "Wo man Zitronat kauft",
      "Wann der Basar beginnt",
    ],
    correctAnswer: "Wo man Zitronat kauft",
  },
  {
    id: 5,
    type: "multiple-choice",
    question: "Im Süden Deutschlands regnet es morgen den ganzen Tag.",
    context:
      "Text 3: Heute Nacht lässt im Süden Deutschlands der Regen nach... Morgen scheint im ganzen Süden Deutschlands die Sonne.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Falsch",
  },
  {
    id: 6,
    type: "multiple-choice",
    question: "Wie sind die Temperaturen morgen im Süden?",
    options: ["Unter 0 Grad", "Zwischen 6 und 14 Grad", "Über 20 Grad"],
    correctAnswer: "Zwischen 6 und 14 Grad",
  },
  {
    id: 7,
    type: "multiple-choice",
    question: "Der Zug nach Hamburg fährt heute pünktlich.",
    context:
      "Text 4: Achtung auf Gleis 7. Der ICE 572 nach Hamburg hat 25 Minuten Verspätung. Wir bitten um Entschuldigung. Reisende nach Bremen können den Regionalexpress auf Gleis 3 nehmen.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Falsch",
  },
  {
    id: 8,
    type: "multiple-choice",
    question: "Was können Reisende nach Bremen tun?",
    options: [
      "Mit dem Bus fahren",
      "Den Regionalexpress auf Gleis 3 nehmen",
      "Den nächsten ICE nehmen",
    ],
    correctAnswer: "Den Regionalexpress auf Gleis 3 nehmen",
  },
  {
    id: 9,
    type: "multiple-choice",
    question: "Mit dem Citypass kann man kostenlos Souvenirs kaufen.",
    context:
      "Text 5: Der Pass beinhaltet ein Ticket... und eine Vorteilskarte... Mit beiden haben Sie... die Gelegenheit... vielleicht ein Souvenir zu kaufen.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Falsch",
  },
  {
    id: 10,
    type: "multiple-choice",
    question: "Für wen ist der Citypass gedacht?",
    options: [
      "Nur für Einwohner",
      "Für Besucher von München",
      "Nur für Studenten",
    ],
    correctAnswer: "Für Besucher von München",
  },
];
...
const hoeren1Teil2: Question[] = [
  {
    id: 11,
    type: "multiple-choice",
    question: "Was ist das Thema des Vortrags?",
    context:
      'Monolog: „Willkommen zum Vortrag über nachhaltiges Reisen. Ich möchte Ihnen heute zeigen, wie Sie umweltfreundlich reisen können, ohne auf Komfort zu verzichten. Wir sprechen über Zugreisen, Ökotourismus und CO2-Kompensation..."',
    options: ["Luxusreisen", "Umweltfreundliches Reisen", "Geschäftsreisen"],
    correctAnswer: "Umweltfreundliches Reisen",
  },
  {
    id: 12,
    type: "multiple-choice",
    question: "Was empfiehlt der Sprecher für Reisen innerhalb Europas?",
    options: ["Das Flugzeug", "Den Zug", "Das Auto"],
    correctAnswer: "Den Zug",
  },
  {
    id: 13,
    type: "multiple-choice",
    question:
      "Wie viel CO2 spart man laut dem Sprecher bei einer Zugfahrt im Vergleich zum Flugzeug?",
    options: ["Etwa 30 Prozent", "Etwa 60 Prozent", "Etwa 80 Prozent"],
    correctAnswer: "Etwa 80 Prozent",
  },
  {
    id: 14,
    type: "multiple-choice",
    question: "Was ist Ökotourismus laut dem Vortrag?",
    options: [
      "Tourismus ohne Hotels",
      "Reisen, die die Natur und lokale Kultur schützen",
      "Reisen nur in Nationalparks",
    ],
    correctAnswer: "Reisen, die die Natur und lokale Kultur schützen",
  },
  {
    id: 15,
    type: "multiple-choice",
    question: "Was können Reisende tun, wenn sie fliegen müssen?",
    options: [
      "Weniger Gepäck mitnehmen",
      "CO2-Kompensation zahlen",
      "Nur Direktflüge buchen",
    ],
    correctAnswer: "CO2-Kompensation zahlen",
  },
];
...
const hoeren1Teil3: Question[] = [
  {
    id: 16,
    type: "multiple-choice",
    question: "Maria hat gerade einen neuen Job angefangen.",
    context:
      "Gespräch zwischen Maria und Thomas über Marias neuen Job in einer Marketingagentur. Sie ist seit zwei Wochen dort und erzählt von ihren Erfahrungen.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Richtig",
  },
  {
    id: 17,
    type: "multiple-choice",
    question: "Maria findet ihre Kollegen unfreundlich.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Falsch",
  },
  {
    id: 18,
    type: "multiple-choice",
    question: "Maria muss jeden Tag ins Büro fahren.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Falsch",
  },
  {
    id: 19,
    type: "multiple-choice",
    question: "Thomas arbeitet auch in einer Agentur.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Falsch",
  },
  {
    id: 20,
    type: "multiple-choice",
    question: "Maria verdient in ihrem neuen Job mehr als vorher.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Richtig",
  },
  {
    id: 21,
    type: "multiple-choice",
    question: "Maria ist mit ihrer Arbeitszeit zufrieden.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Richtig",
  },
  {
    id: 22,
    type: "multiple-choice",
    question: "Thomas plant, sich auch einen neuen Job zu suchen.",
    options: ["Richtig", "Falsch"],
    correctAnswer: "Richtig",
  },
];
...
const hoeren1Teil4: Question[] = [
  {
    id: 23,
    type: "matching",
    question: "23. Kinder verbringen zu viel Zeit am Handy.",
    context:
      'Lesen Sie die Aufgaben 23 bis 30. Wer sagt was?\n\nDiskussion im Radio: Moderatorin Frau Wagner spricht mit Herrn Klein (Lehrer) und Frau Braun (Psychologin) über das Thema „Kinder und Smartphones".\n\na) Moderatorin (Frau Wagner)\nb) Lehrer (Herr Klein)\nc) Psychologin (Frau Braun)',
    options: ["a", "b", "c"],
    correctAnswer: "c",
  },
  {
    id: 24,
    type: "matching",
    question: "24. Smartphones haben auch Vorteile für das Lernen.",
    options: ["a", "b", "c"],
    correctAnswer: "c",
  },
  {
    id: 25,
    type: "matching",
    question: "25. Es gibt oft Probleme mit Handys im Unterricht.",
    options: ["a", "b", "c"],
    correctAnswer: "b",
  },
  {
    id: 26,
    type: "matching",
    question: "26. Wir brauchen klare Regeln für die Handynutzung.",
    options: ["a", "b", "c"],
    correctAnswer: "a",
  },
  {
    id: 27,
    type: "matching",
    question: "27. Ein Handyverbot in der Schule wäre sinnvoll.",
    options: ["a", "b", "c"],
    correctAnswer: "b",
  },
  {
    id: 28,
    type: "matching",
    question: "28. Handys am Abend verschlechtern den Schlaf der Kinder.",
    options: ["a", "b", "c"],
    correctAnswer: "c",
  },
  {
    id: 29,
    type: "matching",
    question: "29. Ein komplettes Handyverbot ist keine Lösung.",
    options: ["a", "b", "c"],
    correctAnswer: "c",
  },
  {
    id: 30,
    type: "matching",
    question: "30. Eltern sollten ein Vorbild bei der Handynutzung sein.",
    options: ["a", "b", "c"],
    correctAnswer: "c",
  },
];
