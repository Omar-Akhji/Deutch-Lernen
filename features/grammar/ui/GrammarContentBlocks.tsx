    ...
    <div className="flex flex-col gap-6">
      {usage && (
        <div className="animate-fade-in space-y-4">
          ...
          <div className="space-y-4 rounded-3xl border border-yellow/10 bg-white/3 px-6 pbs-6 pbe-6 backdrop-blur-md">
            {usage.map((dialogue) => (
              <div
              ...
              >
                ...
                <div className="rounded-2xl rounded-ss-none bg-white/5 px-4 pbs-2 pbe-2 text-white/90">
          ...
          <div className="grid gap-3">
            {block.items.map((item) => {
              ...
              return (
                <div
                  key={text}
                  className="rounded-ie-xl border-is-6px hover:translate-s-1 border-yellow bg-white/5 px-4 pbs-4 pbe-4 text-white/90 backdrop-blur-sm transition-all hover:bg-white/8"
        ...
        <div className="animate-fade-in space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {tips.map((tip) => (
              <div
                key={tip}
                className="flex items-start gap-2 rounded-xl border border-orange/20 bg-orange/5 px-4 pbs-4 pbe-4 text-orange brightness-125"
              >
